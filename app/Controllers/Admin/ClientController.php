...
class ClientController extends BaseController
{
    ...
    {
        return view('admin/clients/create', ['title' => 'Add Client']);
    }
    ...
    {
        return view('admin/clients/edit', ['title' => 'Edit Client', 'client' => $this->clientModel->find($id)]);
    }
    public function update($id)
    {
        ...
        return redirect()->to("admin/clients/$id")->with('success', 'Client updated!');
    }
