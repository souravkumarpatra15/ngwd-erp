...
$routes->group('', ['namespace' => 'App\Controllers'], function ($routes) {
    ...
    $routes->group('admin', ['filter' => 'adminauth'], function ($routes) {
        ...
        $routes->get('deliverables', 'Admin\DeliverableController::index');
        $routes->get('deliverables/create', 'Admin\DeliverableController::create');
        ...
        $routes->post('tasks/reorder', 'Admin\TaskController::reorder');
        $routes->post('tasks/delete/(:num)', 'Admin\TaskController::delete/$1');
        $routes->post('tasks/(:num)/comments', 'Admin\TaskController::addComment/$1');
        $routes->post('tasks/(:num)/subtasks', 'Admin\TaskController::addSubtask/$1');
        $routes->post('tasks/subtasks/(:num)/toggle', 'Admin\TaskController::toggleSubtask/$1');
        $routes->post('tasks/(:num)/attachments', 'Admin\TaskController::uploadAttachment/$1');
        $routes->get('tasks/attachments/(:num)', 'Admin\TaskController::viewAttachment/$1');
        $routes->post('tasks/attachments/(:num)/delete', 'Admin\TaskController::deleteAttachment/$1');
    ...
    $routes->group('portal', ['filter' => 'clientauth'], function ($routes) {
        ...
        $routes->post('team/(:num)/update', 'Client\ClientTeamController::update/$1');
        $routes->post('team/(:num)/toggle', 'Client\ClientTeamController::toggle/$1');
    });
