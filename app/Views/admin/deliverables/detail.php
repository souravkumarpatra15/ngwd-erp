        ...
        <div id="deliverableFilesGrid" class="row g-2">
          ...
          <?php foreach ($files as $f): ?>
            ...
            <div class="col-6 col-md-4" data-deliverable-file="<?= $f['id'] ?>">
              ...
              <?php elseif ($fIsVideo): ?>
                <a href="<?= base_url('admin/deliverables/files/'.$f['id']) ?>" class="d-flex flex-column align-items-center justify-content-center border rounded text-decoration-none text-dark p-2" style="aspect-ratio:16/9"><i class="bi bi-film fs-2 text-muted"></i><span class="small text-truncate w-100 text-center"><?= esc($f['original_name']) ?></span><span class="badge bg-light text-dark border mt-1" style="font-size:10px">Download to play</span></a>
              <?php else: ?>
