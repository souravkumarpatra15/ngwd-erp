...
<div class="tab-content">
  ...
  <div class="tab-pane fade" id="email">
    <div class="card border-0 shadow-sm">
      <div class="card-header bg-white border-0">
        <h6 class="mb-0 fw-semibold">SMTP Email Configuration</h6>
      </div>
      <div class="card-body">
        <form action="<?= base_url('admin/settings/save/email') ?>" method="POST">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-4"><label class="form-label small fw-semibold">Encryption</label><select name="smtp_encryption" class="form-select">
  ...
  <div class="tab-pane fade" id="whatsapp">
    <div class="card border-0 shadow-sm">
      <div class="card-header bg-white border-0">
        <h6 class="mb-0 fw-semibold">WhatsApp Cloud API</h6>
      </div>
      <div class="card-body">
  ...
  <div class="tab-pane fade" id="payment">
    <div class="card border-0 shadow-sm">
      <div class="card-header bg-white border-0">
        <h6 class="mb-0 fw-semibold">Razorpay Integration</h6>
      </div>
      <div class="card-body">
        <form action="<?= base_url('admin/settings/save/payment') ?>" method="POST">
          ...
          <div class="row g-3">
            ...
            <div class="col-12">
              <div class="alert alert-warning small mb-0"><strong>Webhook URL:</strong> <code><?= base_url('webhook/razorpay') ?></code><br>Add in Razorpay Dashboard → Webhooks. Enable: <strong>payment.captured</strong></div>
            </div>
  ...
  <div class="tab-pane fade" id="invoice">
    <div class="card border-0 shadow-sm">
      <div class="card-header bg-white border-0">
        <h6 class="mb-0 fw-semibold">Invoice & Document Settings</h6>
      </div>
      <div class="card-body">
        <form action="<?= base_url('admin/settings/save/invoice') ?>" method="POST">
          <?= csrf_field() ?>
          <div class="row g-3">
            <div class="col-md-4"><label class="form-label small fw-semibold">Invoice Prefix</label><input type="text" name="invoice_prefix" class="form-control" value="<?= esc($settings['invoice_prefix'] ?? 'NGWD') ?>">
              <div class="form-text">Format: PREFIX/YEAR/00001</div>
            </div>
