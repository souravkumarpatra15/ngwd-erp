      ...
      <div class="row g-4">
        ...
        <div class="col-md-8">
          <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-0 py-3"><h6 class="mb-0 fw-semibold">Project Details</h6></div>
            <div class="card-body row g-3">
              <div class="col-12">
                <label class="form-label small fw-semibold">Project Name <span class="text-danger">*</span></label>
                <input type="text" name="name" class="form-control" value="<?= old('name') ?>" required placeholder="e.g. Bong Villa Website">
              </div>
              <div class="col-md-6">
              ...
              <div class="col-12">
                ...
                <textarea name="description" class="form-control" rows="3" placeholder="Project scope and overview..."><?= old('description') ?></textarea>
              </div>
              <div class="col-12">
        ...
        <div class="col-md-4">
            ...
            <div class="card-body row g-3">
              ...
              <div class="col-12">
                ...
                <select name="status" class="form-select">
                  <?php foreach (['pending','development','testing','revision','completed','on_hold'] as $s): ?>
          ...
          <div class="d-grid gap-2">
            <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg me-2"></i>Create Project</button>
