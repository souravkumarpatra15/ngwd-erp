        ...
        <div class="card-body row g-3">
          ...
          <div class="col-md-3">
            ...
            <select name="currency" id="invCurrency" class="form-select">
              <?php $curVal = $invoice['currency'] ?? 'INR'; ?>
...
function recalc() {
  ...
  $('#summSubtotal').text(sym+sub.toLocaleString('en-IN',{minimumFractionDigits:2}));
  $('#summTax').text(sym+tax.toLocaleString('en-IN',{minimumFractionDigits:2}));
  $('#summDiscount').text('-'+sym+disc.toLocaleString('en-IN',{minimumFractionDigits:2}));
  $('#summTotal').text(sym+tot.toLocaleString('en-IN',{minimumFractionDigits:2}));
