...
<body>
  ...
  <?php if (!empty($agreement['client_information'])): ?>
    <div class="section">
      <h2>Client Information</h2><?= nl2br(esc($agreement['client_information'])) ?>
    </div>
  <?php endif; ?>
  <?php if (!empty($agreement['project_information'])): ?>
    <div class="section">
      <h2>Project Information</h2><?= nl2br(esc($agreement['project_information'])) ?>
    </div>
  <?php endif; ?>
  <?php if (!empty($agreement['deliverables'])): ?>
    <div class="section">
      <h2>Deliverables</h2><?= nl2br(esc($agreement['deliverables'])) ?>
    </div>
  <?php endif; ?>
  <?php if (!empty($agreement['timeline'])): ?>
    <div class="section">
      <h2>Timeline</h2><?= nl2br(esc($agreement['timeline'])) ?>
    </div>
  <?php endif; ?>
  <?php if (!empty($agreement['payment_terms'])): ?>
    <div class="section">
      <h2>Payment Terms</h2><?= nl2br(esc($agreement['payment_terms'])) ?>
    </div>
  <?php endif; ?>
  <?php if (!empty($agreement['support_terms'])): ?>
    <div class="section">
      <h2>Support Terms</h2><?= nl2br(esc($agreement['support_terms'])) ?>
    </div>
  <?php endif; ?>
  <?php if (!empty($agreement['cancellation_terms'])): ?>
    <div class="section">
      <h2>Cancellation Policy</h2><?= nl2br(esc($agreement['cancellation_terms'])) ?>
    </div>
  <?php endif; ?>
  <?php if (!empty($agreement['terms_conditions'])): ?>
    <div class="section">
      <h2>Terms & Conditions</h2><?= nl2br(esc($agreement['terms_conditions'])) ?>
    </div>
  <?php endif; ?>
